...
namespace Asandului_Oana_Maria_Lab2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Asandului_Oana_Maria_Lab2Context context)
        {
            _context = context;
        }
        ...
        {
            var asandului_Oana_Maria_Lab2Context = _context.Order.Include(o => o.Book).Include(o => o.Customer);
